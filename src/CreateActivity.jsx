...
import { UploadOutlined, ArrowLeftOutlined, UserOutlined, BellOutlined, DownOutlined, ShopOutlined, HomeOutlined, DollarOutlined, CalendarOutlined, FileTextOutlined, SettingOutlined } from '@ant-design/icons';
      ...
      <Header style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 24px', backgroundColor: '#fff', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
        <div style={{ display: 'flex', alignItems: 'center' }}>
          ...
          <Breadcrumb style={{ margin: 0 }}>
            ...
            <Breadcrumb.Item>新增首单活动</Breadcrumb.Item>
          </Breadcrumb>
        </div>
        <div style={{ display: 'flex', alignItems: 'center' }}>
